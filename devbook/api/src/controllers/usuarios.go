...
func AtualizarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	usrIDNoToken, erro := autenticacao.ExtrairUsuarioID(r)
	if erro != nil {
		respostas.Erro(w, http.StatusUnauthorized, erro)
		return
	}

	if usuarioID != usrIDNoToken {
	...
	//inserir o corpo da requisicao dentro do struct
	var usuario modelos.Usuario
...
func DeletarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	usrIDToken, erro := autenticacao.ExtrairUsuarioID(r)
	if erro != nil {
		respostas.Erro(w, http.StatusUnauthorized, erro)
		return
	}

	if usuarioID != usrIDToken {
...
//Permitir um Usr seguir outro Usr
func SeguirUsuario(w http.ResponseWriter, r *http.Request) {
	//Extrair UsrID do Token
	...
	//verificar se os IDs sao iguais, se for, ERROR, usr nao pode seguir a si mesmo
...
// Permite que um Usr pare de seguir outro
func PararDeSeguirUsuario(w http.ResponseWriter, r *http.Request) {
	//capturar ID do Usr que esta seguindo e o ID do Usr que esta sendo seguido
	seguidorID, erro := autenticacao.ExtrairUsuarioID(r)
	if erro != nil {
		respostas.Erro(w, http.StatusUnauthorized, erro)
		return
...
// Retornar todos os seguidores de 1 Usr
...
// Retorna todos os Ususarios que um determinado Usuario está seguindo
...
//Permite alterar a senha de 1 Usr
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	//capturar o id do usr no token e requisicao
	...
	//verificar no bd se a senha atual bate com a senha cadastrada
	repositorio := repositorios.NovoRepositorioUsuarios(db)
	...
	//comparar a senha salva no DB com a senha atual
	if erro = seguranca.VerificarSenha(senhaSalvaDB, senha.Atual); erro != nil {
		respostas.Erro(w, http.StatusUnauthorized, errors.New("a senha atual não condiz com a sua senha cadastrada"))
		return
	}
	...
	//metodo para inserir a senha no DB
