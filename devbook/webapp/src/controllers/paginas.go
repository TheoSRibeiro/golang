...
func CarregarPaginaPrincipal(w http.ResponseWriter, r *http.Request) {
	...
	defer response.Body.Close() //fechar o corpo da requisicao quando a funcao terminar
...
//Carrega a pagina com usuarios que atendem o filtro passado
...
//Carrega a pagina do Perfil do Usuario
...
//Carrega a pagina do Perfil do Usuario Logado
...
//Carrega a pagina de Edicao dos dados do usuario
func CarregarPaginaEdicaoUsuario(w http.ResponseWriter, r *http.Request) {
	cookie, _ := cookies.Ler(r)
	usuarioID, _ := strconv.ParseUint(cookie["id"], 10, 64)
...
//Carregar a pagina de Atualizacao da Senha do usuario
