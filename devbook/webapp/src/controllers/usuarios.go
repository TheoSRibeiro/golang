...
//Chama a API para cadastrar um usuario no DB
...
//Chama a API para parar de sequir um usuario
...
//Chama a API para atualizar a senha de um usuario
...
//Chama a API para deletar um usuario
